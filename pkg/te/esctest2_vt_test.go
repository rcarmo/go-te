...
// From esctest2/esctest/tests/vt.py::test_VT_Basic
func TestEsctestVtTestVTBasic(t *testing.T) {
	screen := NewScreen(80, 24)
	stream := NewStream(screen, false)
	esctestCUP(t, stream, esctestPoint{X: 5, Y: 3})
	esctestWrite(t, stream, ControlVT)
	pos := esctestGetCursorPosition(screen)
	esctestAssertEQ(t, pos.X, 5)
	esctestAssertEQ(t, pos.Y, 4)
}

// From esctest2/esctest/tests/vt.py::test_VT_Scrolls
func TestEsctestVtTestVTScrolls(t *testing.T) {
	screen := NewScreen(80, 24)
	stream := NewStream(screen, false)
...
// From esctest2/esctest/tests/vt.py::test_VT_ScrollsInTopBottomRegionStartingAbove
func TestEsctestVtTestVTScrollsInTopBottomRegionStartingAbove(t *testing.T) {
	screen := NewScreen(80, 24)
	stream := NewStream(screen, false)
...
// From esctest2/esctest/tests/vt.py::test_VT_ScrollsInTopBottomRegionStartingWithin
func TestEsctestVtTestVTScrollsInTopBottomRegionStartingWithin(t *testing.T) {
	screen := NewScreen(80, 24)
	stream := NewStream(screen, false)
	esctestDECSTBM(t, stream, 4, 5)
	esctestCUP(t, stream, esctestPoint{X: 2, Y: 5})
...
// From esctest2/esctest/tests/vt.py::test_VT_MovesDoesNotScrollOutsideLeftRight
func TestEsctestVtTestVTMovesDoesNotScrollOutsideLeftRight(t *testing.T) {
	screen := NewScreen(80, 24)
	stream := NewStream(screen, false)
...
// From esctest2/esctest/tests/vt.py::test_VT_StopsAtBottomLineWhenBegunBelowScrollRegion
func TestEsctestVtTestVTStopsAtBottomLineWhenBegunBelowScrollRegion(t *testing.T) {
	screen := NewScreen(80, 24)
	stream := NewStream(screen, false)
	esctestDECSTBM(t, stream, 4, 5)
